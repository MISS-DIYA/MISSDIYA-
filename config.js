...
module.exports = {
    ...
    SESSION: process.env.AMALSER_CODE === undefined ? '' : process.env.MISSDIYA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    FAKE: process.env.FAKE_REMOVE === undefined ? 'false' : process.env.FAKE_REMOVE,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/vsv6FY0.jpeg' : process.env.GAN_IMAGE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+917034890656' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Missdiya' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Miss-diya' : process.env.ALL_CAPTION,
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '917034890656@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Missdiya' : process.env.BOT_NAME,
